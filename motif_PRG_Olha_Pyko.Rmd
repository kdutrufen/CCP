...
path_to_files <- "~/PRIMUS/data/83_BIOINFORMATICS/Kadu/motif_PRG_Olha_Pyko/"
path_to_data <- "~/PRIMUS/data/83_BIOINFORMATICS/Kadu/motif_ER1_Olha_Pyko/"
```

# Load fimo results
```{r}
fimo_files <- list.files(path = path_to_files, pattern = "PRG_fimo_out")
...
for(i in seq_along(chr_names)){
    ...
    motif_name <- paste0(chr_names[i], "_PRG")
...
motif_data_overlaps_files <- list.files(path = path_to_files, pattern = "motif_data_overlaps_list_chr_.*PRG.qs", full.names = TRUE)

chr <- list.files(path = path_to_files, pattern = "motif_data_overlaps_list_chr_.*PRG.qs") %>%
...
# motif_data_overlaps_df %>% qs::qsave(file = paste0(path_to_files, "human_PRG_motif_df_with_overlaps.qs"), nthreads = 50)
motif_data_overlaps_df <- qs::qread(file = paste0(path_to_files, "human_PRG_motif_df_with_overlaps.qs"), nthreads = 50)
...
motif_data_overlap_nearest_neighbor_files <- list.files(path = path_to_files, pattern = "motif_data_overlap_nearest_neighbor_list_chr_.*PRG.qs", full.names = TRUE)

chr <- list.files(path = path_to_files, pattern = "motif_data_overlap_nearest_neighbor_list_chr_.*PRG.qs") %>% 
  str_remove(pattern = "motif_data_overlap_nearest_neighbor_list_") %>% 
  str_remove(pattern = "_PRG.qs")
...
motif_data_overlap_nearest_neighbor_list %>% qs::qsave(file = paste0(path_to_files, "human_PRG_motif_data_list_with_overlap_nearest_neighbor.qs"), nthreads = 50)
# motif_data_overlap_nearest_neighbor_list <- qs::qread(file = paste0(path_to_files, "human_PRG_motif_data_list_with_overlap_nearest_neighbor.qs"), nthreads = 50)

motif_data_overlap_nearest_neighbor_df %>% vroom::vroom_write(file = paste0(path_to_files, "human_PRG_motif_df_with_overlap_nearest_neighbor.tsv"), delim = "\t", num_threads = 50)
# motif_data_overlap_nearest_neighbor_df <- vroom::vroom(file = paste0(path_to_files, "human_PRG_motif_df_with_overlap_nearest_neighbor.tsv"), delim = "\t", num_threads = 50)
